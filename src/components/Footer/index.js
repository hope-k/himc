        ...
        <div className='flex bg-[#fff] shadow-lg lg:px-[6rem] px-[2rem] lg:h-[50vh] flex-wrap w-full'>
            <div className='mt-[3rem] flex flex-col'>
                <div className='w-[220px]'>
                    <img src='/hacketthill.png' alt='logo' className='w-full h-auto object-contain' />
                </div>
                <p className='font-light mt-4 max-w-sm text-[15px] text-[#6084a4]'>
            ...
            <div className='w-full flex justify-center border-t border-gray-300 pt-[10px] lg:pt-[20px]'>
                <span className='text-[#6084a4] text-sm font-light'>Copyright © {new Date().getFullYear()} Simmons & Hill Capital </span>
            </div>
        </div>
    )
}
