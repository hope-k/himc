        ...
        <div className=" bg-white z-10 lg:p-12 flex flex-col rounded-2xl relative lg:w-[40%] w-full ">
          ...
          <form className="flex flex-col mx-6 pb-28" onSubmit={submitHandler}>
            ...
            <motion.div layout className="flex justify-evenly">
              ...
              >
                <label className="cursor-pointer w-24 h-24 boed rounded-full bg-gray-100 hover:bg-gray-200 p-4 flex flex-col items-center justify-center border border-teal-500 hover:border-gray-400 transition duration-300 shadow-sm hover:shadow-md">
                  <svg
                  ...
                  <span className="mt-2 text-xs leading-tight text-center text-gray-600">
